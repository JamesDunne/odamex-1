...
CVAR(				sv_coop_completionist_killed, "-1", "Count of killed monsters for coop completionist mode " \
					"for the current map.",
					CVARTYPE_INT, CVAR_SERVERARCHIVE | CVAR_SERVERINFO | CVAR_NOENABLEDISABLE | CVAR_NOSET)

CVAR(				sv_coop_completionist_found, "-1", "Count of found secrets for coop completionist mode " \
					"for the current map.",
					CVARTYPE_INT, CVAR_SERVERARCHIVE | CVAR_SERVERINFO | CVAR_NOENABLEDISABLE | CVAR_NOSET)
